...
import Migration0099 from "./Migrations/099_ExternalAgentProfiles.ts";
import Migration0100 from "./Migrations/100_CapabilityEvidence.ts";
import Migration0101 from "./Migrations/101_ExternalAgentLifecycle.ts";
import Migration0102 from "./Migrations/102_CapabilityEvidenceWithdrawal.ts";
...
export const migrationEntries = [
  ...
  [99, "ExternalAgentProfiles", Migration0099],
  [100, "CapabilityEvidence", Migration0100],
  [101, "ExternalAgentLifecycle", Migration0101],
  [102, "CapabilityEvidenceWithdrawal", Migration0102],
] as const;

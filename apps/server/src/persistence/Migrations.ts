...
import Migration0090 from "./Migrations/090_AutomationFailureTolerance.ts";
import Migration0091 from "./Migrations/091_BackfillAutomationRunThreadSource.ts";
import Migration0092 from "./Migrations/092_BackfillMaxIterationsDisabledReason.ts";
...
export const migrationEntries = [
  ...
  [90, "AutomationFailureTolerance", Migration0090],
  [91, "BackfillAutomationRunThreadSource", Migration0091],
  [92, "BackfillMaxIterationsDisabledReason", Migration0092],
] as const;

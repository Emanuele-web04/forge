  ...
  it.effect("keeps a private database that already recorded old migration 54 compatible", () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(executed, [
        ...
        [99, "ExternalAgentProfiles"],
        [100, "CapabilityEvidence"],
        [101, "ExternalAgentLifecycle"],
        [102, "CapabilityEvidenceWithdrawal"],
      ]);
      ...
      assert.deepStrictEqual(tracker.slice(-48), [
        ...
        { migration_id: 99, name: "ExternalAgentProfiles" },
        { migration_id: 100, name: "CapabilityEvidence" },
        { migration_id: 101, name: "ExternalAgentLifecycle" },
        { migration_id: 102, name: "CapabilityEvidenceWithdrawal" },
      ]);

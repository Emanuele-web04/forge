...
export const DESKTOP_IPC_CHANNELS = {
  ...
  browser: {
    ...
    getProfileState: "desktop:browser-get-profile-state",
    createProfile: "desktop:browser-create-profile",
    renameProfile: "desktop:browser-rename-profile",
    deleteProfile: "desktop:browser-delete-profile",
    setThreadProfile: "desktop:browser-set-thread-profile",
    clearProfileData: "desktop:browser-clear-profile-data",
    getChromeProfileState: "desktop:browser-get-chrome-profile-state",
    openChromeSignIn: "desktop:browser-open-chrome-sign-in",
    importChromeSession: "desktop:browser-import-chrome-session",
